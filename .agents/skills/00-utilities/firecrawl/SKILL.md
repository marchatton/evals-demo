---
name: firecrawl
description: Web search/scrape/crawl via Firecrawl CLI (prefer for live internet lookups).
---

# Firecrawl CLI

Use the `firecrawl` CLI to fetch and search the web. If the user asks for information from the internet, use Firecrawl skill.
