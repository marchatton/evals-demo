...
- [ ] All 8 slices complete their audits
...
If $ARGUMENTS specifies a single principle (e.g., "action parity"), only run that agent and provide detailed findings for that principle alone.
